...
if __name__ == '__main__':
    ...
    print(f'有效周数（跳过2025-W01）: {len(valid_weeks)}')
    ...
    out = os.path.join(OUTPUT_DIR, f'bt_G3_SKIP_2025W01_{ts}.json')
