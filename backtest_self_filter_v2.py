...
if __name__ == '__main__':
    ...
    cases = [
        ...
        ('G6: 三周≥3%  + 本周≥0%',             0.03,  0.00),
        ('G7: 三周≥0%  + 本周≥-3%',            0.00, -0.03),
    ]

    results = []
    for label, m3, m1 in cases:
        tag3 = '>0%' if m3 == 0 else (f'{m3:+.0f}%' if m3 != 0 else '>0%')
    ...
    out = os.path.join(OUTPUT_DIR, f'bt_self_filter_v2_{ts}.json')
