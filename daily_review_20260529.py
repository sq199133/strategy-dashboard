...
# 今日实时行情
TODAY = {
    '159902': {'close': 5.022, 'prev': 5.116, 'chg': -1.84},
    '160723': {'close': 2.108, 'prev': 2.158, 'chg': -2.31},
    '161128': {'close': 7.038, 'prev': 6.871, 'chg': +2.43},
}

print("=" * 70)
print("更新ETF数据：2026-05-29")
print("=" * 70)
...
if s128:
    ...
    print(f"  止盈线: {take_profit:.3f} (距当前 {(take_profit-current)/current*100:+.1f}%)")
