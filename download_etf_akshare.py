...
# -*- coding: utf-8 -*-
"""
Download ETF historical data using AKShare (fixed encoding)
- 使用 adjust='hfq' (后复权)
- 添加Windows控制台编码修复
"""
...
def main():
    print("=" * 70)
    print("  AKShare ETF Data Downloader (Fixed Encoding)")
    print("=" * 70)
    ...
    for i, etf in enumerate(etfs, 1):
        code = etf['code']
        name = clean_text(etf.get('name', ''))  # Clean name for safe printing
