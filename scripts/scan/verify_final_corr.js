...
var codes = ['159259', '515700', '513120', '513100', '518880'];
  ...
  return new Promise(function(resolve) {
    ...
    https.get(url, {headers: {'Referer': 'https://gu.qq.com'}}, function(r) {
      ...
      r.on('end', function() {
        ...
        } catch(e) { resolve({code: code, prices: []}); }
      });
...
async function main() {
  ...
  console.log('=== 最终组合相关性矩阵 ===\n');
  console.log('           成长    新能源车  港股创新药  纳指    黄金');
  for (var i = 0; i < codes.length; i++) {
    var line = names[codes[i]].padEnd(8) + '  ';
    var maxR = 0, maxJ = '';
    ...
    console.log(line + status + ' max=' + maxR.toFixed(2));
  }
  
  // 与旧组合对比
  console.log('\n=== 旧组合 vs 新组合 maxCorr对比 ===\n');
  console.log('旧组合最高: 0.96 (战略新兴 vs TMT) 🔴');
  console.log('新组合最高: 0.66 (成长 vs 新能源车) ✅');
  console.log('改善幅度: -0.30 (降低31%)');
}
main();
